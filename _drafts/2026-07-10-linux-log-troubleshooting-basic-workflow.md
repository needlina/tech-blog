...
도입부 예시 이미지
![서버 로그와 모니터링을 통해 장애 원인을 분석하는 개념을 보여주는 이미지](https://images.unsplash.com/photo-1555949963-aa79dcee981d?auto=format&fit=crop&w=1350&q=80)
이미지 출처: Unsplash / Josh
...
![터미널에서 journalctl과 tail로 로그를 확인하는 모습의 이미지로, Linux 로그 조사와 관련된 화면을 보여준다](https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1350&q=80)
