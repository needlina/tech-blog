...
tags: ["blogging", "github-actions", "continuous-testing", "code-snippets", "automation"]
image:
...
## 관련 이미지 주제
1. 코드 스니펫 폴더와 CI 파이프라인이 연결된 단순한 개념 다이어그램
2. 컨테이너(도커) 기반으로 격리된 실행 환경을 보여주는 단순한 박스 일러스트
