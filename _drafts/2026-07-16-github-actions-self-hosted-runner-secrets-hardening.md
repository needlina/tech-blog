...
tags: ["github-actions", "self-hosted", "secrets-management", "security", "news", "trend"]
image:
...
## 관련 이미지 주제
1. self-hosted 러너가 격리된 네트워크 단위로 표시된 단순한 기술 개념 일러스트  
2. 러너 등록·비활성화 과정을 아이콘으로 나타낸 단계별 흐름도
