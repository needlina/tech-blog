...
소감
느낀 건, Terraform 공급자와 lockfile 관련 작업은 작은 설정 하나가 배포 파이프라인 전체에 영향을 줄 수 있다는 점입니다. 그래서 “작은 환경에서 먼저 확인하고, CI에 적용하고, 문서와 체크리스트로 보완”하는 방식이 가장 안전하다고 생각합니다. 이 문서는 정리한 정리라 틀린 부분이 있을 수 있어요 — 사용하시는 Terraform 버전의 공식 문서를 참고하시고, 궁금한 부분이 있으면 함께 찾아보면 좋겠습니다.
