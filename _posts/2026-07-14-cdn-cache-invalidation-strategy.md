...
tags: ["cdn", "cache-control", "캐시무효화", "devops", "cloud"]
image:
...
그래서 요즘은 가능한 전체 퍼지를 피하고, 더 세밀한 무효화 전략을 쓰려고 합니다. 이 글에서는 정리한 방법들과 실무에서 체크하면 좋은 포인트들을 정리합니다. 처음 다루는 관점에서 정리한 것이므로 모든 사례에 딱 맞지는 않을 수 있습니다.
...
정리한 내용은 실무 환경이나 CDN에 따라 동작 방식이 달라질 수 있으니, 적용 전에 해당 CDN 문서를 확인하고 작은 범위에서 실험해 보시길 권합니다.
