...
description: ": Sigstore(cosign/rekor/fulcio) 기반 CI 코드·이미지 서명 파이프라인 도입 체크리스트를 정리합니다. 개인적으로 정리한 초안이라 틀릴 가능성이 있고, 실무 환경에 맞게 조정하면 좋겠습니다"
...
: Sigstore(cosign/rekor/fulcio) 기반 CI 코드·이미지 서명 파이프라인 도입 체크리스트를 정리합니다. 개인적으로 정리한 초안이라 틀릴 가능성이 있고, 실무 환경에 맞게 조정하면 좋겠습니다
