...
![CI에서 같은 브랜치인데도 오래된 의존성이 다시 설치된다 일러스트](/assets/img/posts/blog/monorepo-ci-branch-docker-cache-partitioning-strategy/image-1.webp)
...
![Monorepo CI에서 브랜치별 Docker 레이어 구조도 일러스트](/assets/img/posts/blog/monorepo-ci-branch-docker-cache-partitioning-strategy/image-2.webp)
