...
description: "\"무중단으로 데이터베이스 스키마 마이그레이션을 롤아웃하고, 안전하게 롤백하는 방법\"을 공부한 내용을 정리하려고 합니다. 저는 아직 처음 다루는 입장에서 라 완벽하진 않지만, 확인하며 남긴 메모과 처음 확인할 때 막히는 부분, 그리고 운영에서 확인할 지점 중심으로 차근차근"
...
"무중단으로 데이터베이스 스키마 마이그레이션을 롤아웃하고, 안전하게 롤백하는 방법"을 공부한 내용을 정리하려고 합니다. 저는 아직 처음 다루는 입장에서 라 완벽하진 않지만, 확인하며 남긴 메모과 처음 확인할 때 막히는 부분, 그리고 운영에서 확인할 지점 중심으로 차근차근 적어봅니다. 틀릴 수 있는 부분은 조심스럽게 표현하려고 하고요, 실제 환경에 적용하기 전에는 반드시 테스트 환경에서 확인해보시길 권합니다.
