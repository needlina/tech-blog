...
---
서두에 한마디: 이 문서는 정리한 개인적인 체험과 실무에서 제가 자주 사용하는 기본 흐름을 모아둔 것입니다. 전문가의 절대적인 지침이라기보다는 함께 점검해보면 좋을 포인트로 봐주시면 좋겠습니다.
...
- 이 문서는 제가 현장에서 자주 쓰는 기본 흐름과 체크포인트를 모은 것입니다. 환경에 따라 필요 없는 항목도 있고, 추가로 확인해야 할 항목도 있을 수 있으니 프로젝트 상황에 맞게 조정하면 됩니다.

혹시 특정 환경(예: nginx + gunicorn, k8s cluster, AWS EC2 등)에 맞춰 예시 로그 확인 절차를 더 원하시면 알려주세요.
