...
tags: ["docker", "이미지최적화", "container", "devops", "linux"]
image:
...
Docker 이미지 크기를 줄일 때 실무에서 확인하면 도움이 되는 포인트들을 정리해봤습니다. 개인적으로 프로젝트를 운영하면서 이미지가 커져서 빌드·배포 시간이 늘어나고 레지스트리 비용이 올라가는 문제를 겪었는데, 그 과정에서 공부한 내용을 초보자의 관점에서 차근차근 적어보려 합니다. 섣불리 일반화하지 않으려 노력했고, 제가 확인해 본 절차와 예제 중심으로 정리했습니다.
